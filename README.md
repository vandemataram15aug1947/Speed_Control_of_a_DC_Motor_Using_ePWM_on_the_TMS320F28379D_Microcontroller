...
# **TMS320F28379D-Based Open-Loop Speed Control of a DC Motor Using PWM**  

## **Introduction**  
This project implements **Open-Loop Speed Control of a DC Motor** using **Pulse Width Modulation (PWM)** signals generated by the **TMS320F28379D** microcontroller. The motor speed is controlled by varying the **PWM duty cycle**, which is adjusted based on the **ADC (Analog-to-Digital Converter) input** from a **potentiometer**. This allows for **smooth and precise speed adjustments** without the need for feedback control.  
